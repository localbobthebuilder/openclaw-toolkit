...
export class ToolkitDashboard extends ToolkitDashboardRenderMixin(LitElement) {
  ...
  static styles = css`
    ...
    .config-toolbar-tabs { display: inline-flex; gap: 10px; padding: 6px; border: 1px solid #2f2f2f; border-radius: 14px; background: #171717; box-shadow: inset 0 1px 0 rgba(255,255,255,0.03); width: fit-content; flex-wrap: wrap; }
